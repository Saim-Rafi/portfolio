    ...
    >
      ...
      <div className="section-container flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="flex flex-col max-w-xl space-y-6 text-center lg:text-left">
          <motion.span
            className="text-xl md:text-2xl font-medium text-primary opacity-90"
          ...
          >
            Full-Stack Developer & Aspiring Software Engineering
          </motion.p>
            ...
            >
              ...
              <div className="space-y-2 font-mono text-sm">
                ...
                >
                  ...
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-green-600">'Mohd Saim Rafi'</span>
                  <span className="text-gray-500">,</span>
                </motion.div>
